...
getSnapShotNoSharingM epochStateId snapShotType = do
  ...
  delegations <-
    selectKVVector [SnapShotDelegationSnapShotId ==. snapShotId] $ \SnapShotDelegation {..} -> do
...
{-# INLINE getSnapShotsWithSharingM #-}
...
{-# INLINE loadSnapShotsNoSharingM #-}
