    ...
    let txBody = getField @"body" tx
        ...
        newWitnessSet =
          mkTxWits @era
            ...
            sw
            (hashAnnotated body2)
     in -- updateEraTx utxo scriptinfo tx body2 newWitnessSet
        Tx @era body2 newWitnessSet _auxdata
...
converge
  ...
  tx = do
    ...
    pure (applyDelta utxo scriptinfo pparams neededKeys neededScripts keySpace tx delta)
